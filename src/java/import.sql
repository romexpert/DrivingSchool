...
INSERT INTO PEOPLE (IID, AccountRole, email, name, password_hash, phone, group_id, instructor_id) VALUES (1, 'Admin', 'admin@driftman.ru', 'Admin Andry', 'admin@driftman.ru', '1 2345678', NULL, NULL);
